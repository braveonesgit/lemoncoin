...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 LMC
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 LMC mininput
/** No amount larger than this (in satoshi) is valid */
static const int64 MAX_MONEY = 1000000000 * COIN; // Lemoncoin: maximum of 10B coins (given some randomness), max transaction 1,000,000,000 for now
